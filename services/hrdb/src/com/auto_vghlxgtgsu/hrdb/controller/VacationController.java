...
import com.auto_vghlxgtgsu.hrdb.service.VacationService;
...
public class VacationController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportVacationsAndGetURL(@RequestBody DataExportOptions options, Pageable pageable) {
